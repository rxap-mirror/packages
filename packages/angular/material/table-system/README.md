...
```bash
yarn add @angular/animations@^19.1.3 @angular/cdk@^19.1.1 @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/forms@^19.1.3 @angular/material@^19.1.1 @angular/router@^19.1.3 @rxap/components@^19.0.2-dev.3 @rxap/data-source@^19.0.2-dev.3 @rxap/directives@^19.0.2-dev.2 @rxap/forms@^19.0.2-dev.2 @rxap/material-directives@^19.0.2-dev.3 @rxap/pattern@^1.1.12-dev.1 @rxap/reflect-metadata@^1.0.14-dev.2 @rxap/rxjs@^1.1.13-dev.2 @rxap/utilities@^16.4.3-dev.2 @rxap/window-system@^19.0.2-dev.3 rxjs@^7.8.1 
```
