...
```bash
yarn add @angular/animations@^19.1.3 @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/forms@^19.1.3 @angular/material@^19.1.1 @angular/router@^19.1.3 @rxap/authentication@^19.0.1 @rxap/config@^19.0.1 @rxap/forms@^19.0.1 @rxap/material-form-system@^19.0.1 @rxap/pattern@^1.1.11 @rxap/rxjs@^1.1.12 @rxap/utilities@^16.4.2 rxjs@^7.8.1 
```
