...
```bash
yarn add @angular/animations@^19.1.3 @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/forms@^19.1.3 @angular/material@^19.1.1 @angular/router@^19.1.3 @rxap/authentication@^19.0.2-dev.2 @rxap/config@^19.0.2-dev.2 @rxap/forms@^19.0.2-dev.1 @rxap/material-form-system@^19.0.2-dev.2 @rxap/pattern@^1.1.12-dev.1 @rxap/rxjs@^1.1.13-dev.1 @rxap/utilities@^16.4.3-dev.1 rxjs@^7.8.1 
```
