...
```bash
yarn add @angular/core@^19.1.3 @angular/material@^19.1.1 @rxap/browser-utilities@^1.1.10 @rxap/ngx-memory@^19.0.1 @rxap/rxjs@^1.1.12 @rxap/utilities@^16.4.2 rxjs@^7.8.1 
```
