...
```bash
yarn add @angular/core@^19.1.3 @angular/material@^19.1.1 @rxap/browser-utilities@^1.1.11-dev.1 @rxap/ngx-memory@^19.0.2-dev.1 @rxap/rxjs@^1.1.13-dev.2 @rxap/utilities@^16.4.3-dev.2 rxjs@^7.8.1 
```
