...
```bash
yarn add @angular/core@^19.1.3 @angular/material@^19.1.1 @rxap/browser-utilities@^1.1.11 @rxap/ngx-memory@^19.0.2 @rxap/rxjs@^1.1.13 @rxap/utilities@^16.4.3 rxjs@^7.8.1 
```
