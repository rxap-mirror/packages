...
```bash
yarn add @angular/cdk@^19.1.1 @angular/core@^19.1.3 @angular/material@^19.1.1 @rxap/data-source@^19.0.2-dev.1 @rxap/form-system@^19.0.2-dev.1 @rxap/forms@^19.0.2-dev.0 @rxap/material-table-system@^19.0.2-dev.1 @rxap/mixin@^16.0.13-dev.0 @rxap/pattern@^1.1.12-dev.0 @rxap/utilities@^16.4.3-dev.0 @rxap/window-system@^19.0.2-dev.1 rxjs@^7.8.1 
```
