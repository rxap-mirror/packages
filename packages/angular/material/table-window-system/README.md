...
```bash
yarn add @angular/cdk@^19.1.1 @angular/core@^19.1.3 @angular/material@^19.1.1 @rxap/data-source@^19.0.1 @rxap/form-system@^19.0.1 @rxap/forms@^19.0.1 @rxap/material-table-system@^19.0.1 @rxap/mixin@^16.0.12 @rxap/pattern@^1.1.11 @rxap/utilities@^16.4.2 @rxap/window-system@^19.0.1 rxjs@^7.8.1 
```
