...
```bash
yarn add @angular/cdk@^19.1.1 @angular/core@^19.1.3 @angular/material@^19.1.1 @rxap/data-source@^19.0.2 @rxap/form-system@^19.0.2 @rxap/forms@^19.0.2 @rxap/material-table-system@^19.0.2 @rxap/mixin@^16.0.13 @rxap/pattern@^1.1.12 @rxap/utilities@^16.4.3 @rxap/window-system@^19.0.2 rxjs@^7.8.1 
```
