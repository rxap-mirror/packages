...
```bash
yarn add @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/forms@^19.1.3 @angular/material@^19.1.1 @rxap/directives@^19.0.2-dev.0 @rxap/ngx-localize@^19.0.2-dev.1 rxjs@^7.8.1 
```
