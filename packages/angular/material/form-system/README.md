...
```bash
yarn add @angular/cdk@^19.1.1 @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/forms@^19.1.3 @angular/material@^19.1.1 @angular/router@^19.1.3 @rxap/form-system@^19.0.2-dev.2 @rxap/forms@^19.0.2-dev.1 @rxap/mixin@^16.0.13-dev.1 @rxap/reflect-metadata@^1.0.14-dev.1 @rxap/utilities@^16.4.3-dev.1 rxjs@^7.8.1 
```
