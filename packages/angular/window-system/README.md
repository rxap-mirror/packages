...
```bash
yarn add @angular/cdk@^19.1.1 @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/material@^19.1.1 @rxap/directives@^19.0.2-dev.0 @rxap/material-directives@^19.0.2-dev.1 @rxap/rxjs@^1.1.13-dev.0 @rxap/services@^19.0.2-dev.0 @rxap/utilities@^16.4.3-dev.0 rxjs@^7.8.1 
```
