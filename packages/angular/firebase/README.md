...
```bash
yarn add @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/fire@^7.5.0 @rxap/config@^19.0.2-dev.0 @rxap/rxjs@^1.1.13-dev.0 @rxap/utilities@^16.4.3-dev.0 firebase@^9.23.0 rxjs@^7.8.1 
```
