...
```bash
yarn add @angular/common@^19.1.3 @angular/core@^19.1.3 @rxap/config@^19.0.2-dev.2 @rxap/data-source@^19.0.2-dev.2 @rxap/environment@^19.0.2-dev.1 @rxap/mixin@^16.0.13-dev.1 @rxap/remote-method@^19.0.2-dev.1 @rxap/rxjs@^1.1.13-dev.1 @rxap/utilities@^16.4.3-dev.1 ajv@^8.12.0 openapi-types@^10.0.0 rxjs@^7.8.1 
```
