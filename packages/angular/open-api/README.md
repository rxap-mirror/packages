...
```bash
yarn add @angular/common@^19.1.3 @angular/core@^19.1.3 @rxap/config@^19.0.1 @rxap/data-source@^19.0.1 @rxap/environment@^19.0.1 @rxap/mixin@^16.0.12 @rxap/remote-method@^19.0.1 @rxap/rxjs@^1.1.12 @rxap/utilities@^16.4.2 ajv@^8.12.0 openapi-types@^10.0.0 rxjs@^7.8.1 
```
