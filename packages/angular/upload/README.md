...
```bash
yarn add @angular/cdk@^19.1.1 @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/forms@^19.1.3 @angular/material@^19.1.1 @rxap/directives@^19.0.2-dev.1 @rxap/pattern@^1.1.12-dev.1 rxjs@^7.8.1 
```
