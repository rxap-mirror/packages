...
```bash
yarn add @angular/core@^19.1.3 @angular/platform-browser@^19.1.3 @angular/platform-browser-dynamic@^19.1.3 @rxap/config@^19.0.1 @rxap/environment@^19.0.1 ngx-logger@^5.0.12 
```
