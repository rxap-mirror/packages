...
```bash
yarn add @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/service-worker@^19.1.3 @rxap/environment@^19.0.2-dev.0 @rxap/life-cycle@^19.0.2-dev.0 rxjs@^7.8.1 
```
