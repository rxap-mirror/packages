...
```bash
yarn add @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/material@^19.1.1 @angular/router@^19.1.3 @rxap/config@^19.0.2-dev.0 @rxap/open-api@^19.0.2-dev.0 @sentry/angular@^8.18.0 rxjs@^7.8.1 
```
