...
```bash
yarn add @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/router@^19.1.3 @rxap/config@^19.0.2-dev.2 @rxap/data-source@^19.0.2-dev.2 @rxap/ngx-pub-sub@^19.0.2-dev.1 @rxap/pattern@^1.1.12-dev.1 rxjs@^7.8.1 
```
