...
```bash
yarn add @angular/cdk@^19.1.1 @angular/core@^19.1.3 @rxap/directives@^19.0.2-dev.1 @rxap/form-system@^19.0.2-dev.2 @rxap/forms@^19.0.2-dev.1 @rxap/pattern@^1.1.12-dev.1 @rxap/reflect-metadata@^1.0.14-dev.1 @rxap/rxjs@^1.1.13-dev.1 @rxap/utilities@^16.4.3-dev.1 @rxap/window-system@^19.0.2-dev.2 rxjs@^7.8.1 
```
