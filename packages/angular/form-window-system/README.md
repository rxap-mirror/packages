...
```bash
yarn add @angular/cdk@^19.1.1 @angular/core@^19.1.3 @rxap/directives@^19.0.2 @rxap/form-system@^19.0.2 @rxap/forms@^19.0.2 @rxap/pattern@^1.1.12 @rxap/reflect-metadata@^1.0.14 @rxap/rxjs@^1.1.14 @rxap/utilities@^16.4.3 @rxap/window-system@^19.0.2 rxjs@^7.8.1 
```
