...
```bash
yarn add @angular/cdk@^19.1.1 @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/material@^19.1.1 @rxap/contenteditable@^19.0.1 @rxap/data-source@^19.0.1 @rxap/data-structure-tree@^1.1.12 @rxap/forms@^19.0.1 @rxap/material-directives@^19.0.1 @rxap/pattern@^1.1.11 @rxap/rxjs@^1.1.12 @rxap/utilities@^16.4.2 rxjs@^7.8.1 
```
