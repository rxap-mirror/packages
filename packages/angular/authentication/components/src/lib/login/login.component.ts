...
@Component({
  ...
  imports: [
    ...
    MatFormFieldModule,
    MatInputModule,
    FormControlErrorDirective, NgIf, MatButtonModule, MatCheckboxModule, MatTooltipModule, MatProgressSpinnerModule,
    FormControlMarkDirtyDirective, FormSubmitFailedDirective, FormSubmittingDirective, MatProgressBarModule, AsyncPipe,
    MatSnackBarModule,
  ],
})
