...
export type HttpPaginationDataSourceMetadata = AbstractPaginationDataSourceMetadata
...
export function RxapHttpPaginationDataSource<Data>(
  ...
  className = 'HttpPaginationDataSource',
  packageName = '@rxap/data-source/http/pagination',
) {
