...
```bash
yarn add @angular/cdk@^19.1.1 @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/material@^19.1.1 @rxap/data-structure-tree@^1.1.13-dev.3 @rxap/definition@^19.0.2-dev.2 @rxap/environment@^19.0.2-dev.1 @rxap/pattern@^1.1.12-dev.1 @rxap/rxjs@^1.1.13-dev.2 @rxap/utilities@^16.4.3-dev.2 rxjs@^7.8.1 
```
