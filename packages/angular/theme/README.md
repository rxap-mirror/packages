...
```bash
yarn add @angular/cdk@^19.1.1 @angular/core@^19.1.3 @rxap/config@^19.0.2-dev.0 @rxap/ngx-pub-sub@^19.0.2-dev.0 @rxap/rxjs@^1.1.13-dev.0 @rxap/utilities@^16.4.3-dev.0 rxjs@^7.8.1 
```
