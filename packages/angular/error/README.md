...
```bash
yarn add @angular/cdk@^19.1.1 @angular/common@^19.1.3 @angular/core@^19.1.3 @rxap/components@^19.0.1 @rxap/config@^19.0.1 @rxap/data-grid@^19.0.1 @rxap/environment@^19.0.1 @rxap/open-api@^19.0.1 @sentry/angular@^8.18.0 rxjs@^7.8.1 
```
