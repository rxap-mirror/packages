...
```bash
yarn add @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/forms@^19.1.3 @rxap/directives@^19.0.2 @rxap/environment@^19.0.2 @rxap/open-api@^19.0.2 ngx-markdown@^16.0.0 rxjs@^7.8.1 
```
