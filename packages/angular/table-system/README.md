...
```bash
yarn add @angular/animations@^19.1.3 @angular/cdk@^19.1.1 @angular/common@^19.1.3 @angular/core@^19.1.3 @angular/forms@^19.1.3 @angular/material@^19.1.1 @rxap/data-source@^19.0.2-dev.3 @rxap/material-table-system@^19.0.2-dev.3 @rxap/utilities@^16.4.3-dev.2 rxjs@^7.8.1 
```
