...
```bash
yarn add @angular/core@^19.1.3 @angular/forms@^19.1.3 @angular/router@^19.1.3 @rxap/definition@^19.0.1 @rxap/directives@^19.0.1 @rxap/pattern@^1.1.11 @rxap/reflect-metadata@^1.0.13 @rxap/rxjs@^1.1.12 @rxap/services@^19.0.1 @rxap/utilities@^16.4.2 @rxap/validator@^3.0.11 rxjs@^7.8.1 
```
