...
```bash
yarn add @angular/core@^19.1.3 @rxap/data-source@^19.0.2-dev.0 @rxap/ngx-pub-sub@^19.0.2-dev.0 @rxap/open-api@^19.0.2-dev.0 @rxap/utilities@^16.4.3-dev.0 rxjs@^7.8.1 
```
