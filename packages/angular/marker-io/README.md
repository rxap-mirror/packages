...
```bash
yarn add @angular/core@^19.1.3 @marker.io/browser@^0.19.0 @rxap/config@^19.0.2-dev.3 @rxap/environment@^19.0.2-dev.1 @rxap/ngx-pub-sub@^19.0.2-dev.1 @rxap/utilities@^16.4.3-dev.2 rxjs@^7.8.1 
```
