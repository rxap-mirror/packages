...
```bash
yarn add @angular/core@^19.1.3 @angular/router@^19.1.3 @rxap/authentication@^19.0.2 @rxap/rxjs@^1.1.14 angular-oauth2-oidc@^15.0.1 angular-oauth2-oidc-jwks@^15.0.1 rxjs@^7.8.1 
```
