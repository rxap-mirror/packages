 ...
 */
const ibanRegexThroughCountryCode: Record<string, RegExp> = {
...
export function isIBAN(str: unknown) {
  assertString(str);

  return hasValidIbanFormat(str) && hasValidIbanChecksum(str);
}

export const isIBANLocales = Object.keys(ibanRegexThroughCountryCode);
