...
describe('NormalizeFormHeaderButton', () => {
  it('should normalize form header button', () => {
    ...
    const result = NormalizeFormHeaderButton(options as any);
  ...
  it('should throw if form is missing', () => {
    expect(() => NormalizeFormHeaderButton({ kind: HeaderButtonKind.FORM } as any)).toThrow('The form property is required for a form header button');
  });
