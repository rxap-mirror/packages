 ...
 */
export function AddDir(dir: DirEntry, project: Project, parentPath = '', filter: ((pathFragment: string, dirEntry: DirEntry) => boolean) = pathFragment => !!pathFragment.match(/\.ts$/)) {
