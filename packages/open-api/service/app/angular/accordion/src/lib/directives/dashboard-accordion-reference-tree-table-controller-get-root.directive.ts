...
export class DashboardAccordionReferenceTreeTableControllerGetRootRemoteMethodTemplateCollectionDirective extends RemoteMethodTemplateCollectionDirective<ArrayElement<DashboardAccordionReferenceTreeTableControllerGetRootResponse>, OpenApiRemoteMethodParameter<DashboardAccordionReferenceTreeTableControllerGetRootParameter, void>> {
  @Input('dashboardAccordionReferenceTreeTableControllerGetRootCollectionRemoteMethodParameters')
  declare public parameters?: OpenApiRemoteMethodParameter<DashboardAccordionReferenceTreeTableControllerGetRootParameter, void>;
...
export class DashboardAccordionReferenceTreeTableControllerGetRootRemoteMethodTemplateDirective extends RemoteMethodTemplateDirective<DashboardAccordionReferenceTreeTableControllerGetRootResponse, OpenApiRemoteMethodParameter<DashboardAccordionReferenceTreeTableControllerGetRootParameter, void>> {
...
export class DashboardAccordionReferenceTreeTableControllerGetRootRemoteMethodDirective extends RemoteMethodDirective<DashboardAccordionReferenceTreeTableControllerGetRootResponse, OpenApiRemoteMethodParameter<DashboardAccordionReferenceTreeTableControllerGetRootParameter, void>> {
