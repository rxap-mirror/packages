...
@OperationCommand({
    ...
    operation: '{"operationId":"DashboardAccordionGeneralInformationDataGridController_get","parameters":[],"responses":{"200":{"content":{"application/json":{"schema":{"type":"object","properties":{}}}}}},"method":"get","path":"/dashboard-accordion/{uuid}/general-information-data-grid"}'
  })
