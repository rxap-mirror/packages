  ...
  describe('Elements', () => {
    ...
    describe('OptionElement', () => {
      ...
      it('should parse option without defined value', () => {
        ...
        expect(optionElement.getControlOption())
          .toEqual({
            value: 'my-display',
            display: 'my-display',
          });
      ...
      it('should parse option with string value', () => {
        ...
        let optionElement = xmlParser.parseFromXmlTesting(
          '<option value="my-value" >my-display</option>',
          OptionElement,
        );
...
<data-source>my-data-source-id</data-source>
      ...
      it('should parse options element with toDisplay', () => {
        ...
        expect(() => xmlParser.parseFromXmlTesting(
          `<options><to-display>my-data-source-id</to-display></options>`,
          OptionsElement,
        )).toThrowError();
