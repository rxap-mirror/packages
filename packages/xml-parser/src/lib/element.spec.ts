    ...
    ({
      ...
      `;
        ...
        it('should return all child nodes', () => {
          ...
          const element = new RxapElement(
            new DOMParser().parseFromString('<root><child-1/><child-2/></root>', 'text/xml')
              .childNodes
        ...
        it('should return specified children text contents', () => {
          ...
          expect(element.getChildrenTextContent('child-1')).toEqual(
            [ undefined, { 'username': 'username-e' }, undefined ]);
        ...
        it('should get element text content', () => {
          ...
          const element = new RxapElement(
            new DOMParser().parseFromString('<root>content</root>', 'text/xml').documentElement, DOMParser);
