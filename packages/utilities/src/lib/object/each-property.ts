 ...
 *
 */
export function* EachProperty(obj: any, path: string[] = [], parent: any = obj): Iterable<{ value: unknown, key: any, propertyPath: string, isObject: boolean, isArray: boolean, isPrimitive: boolean, parent: any }> {
