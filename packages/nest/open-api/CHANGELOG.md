...
- **nest-open-api:** fix request-id log, guard non-HTTP contexts and axios import
...
# [11.0.0](https://gitlab.com/rxap/packages/compare/@rxap/nest-open-api@11.0.0-dev.2...@rxap/nest-open-api@11.0.0) (2026-01-23)
...
# [10.6.0](https://gitlab.com/rxap/packages/compare/@rxap/nest-open-api@10.6.0-dev.1...@rxap/nest-open-api@10.6.0) (2025-05-16)

**Note:** Version bump only for package @rxap/nest-open-api

# [10.6.0-dev.1](https://gitlab.com/rxap/packages/compare/@rxap/nest-open-api@10.6.0-dev.0...@rxap/nest-open-api@10.6.0-dev.1) (2025-04-15)

### Bug Fixes

- use correct logger ([302d289](https://gitlab.com/rxap/packages/commit/302d28992fc70f92853cb52a1d01381a1adf3a91))
