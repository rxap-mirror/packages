...
```bash
yarn add @nestjs/common@^10.3.8 @nestjs/config@^3.2.2 @nestjs/core@^10.3.8 @nestjs/microservices@^10.3.8 @nestjs/swagger@^7.3.1 @rxap/nest-utilities@^10.4.0 @rxap/utilities@^16.4.2 cookie-parser@^1.4.6 helmet@^7.1.0 
```
