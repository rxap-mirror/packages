...
```bash
yarn add @nestjs/common@^10.3.8 @nestjs/config@^3.2.2 @nestjs/microservices@^10.3.8 @nestjs/terminus@^10.2.3 @rxap/utilities@^16.4.3-dev.0 amqp-connection-manager@^4.1.14 amqplib@^0.10.4 rxjs@^7.8.1 
```
