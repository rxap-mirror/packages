 ...
 * @Injectable()
 * class AppService {
 *   constructor(private readonly auth0Service: Auth0AuthenticationService) {}
 *
 *   async getToken() {
 ...
 * const auth0Service = new Auth0AuthenticationService({
 ...
 */
@Injectable()
export class Auth0AuthenticationService extends AuthenticationClient {
  constructor(
   ...
   * @example
   * ```typescript
   * const auth0Service = new Auth0AuthenticationService(options);
   * try {
