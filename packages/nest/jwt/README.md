...
```bash
yarn add @nestjs/common@^10.3.8 @nestjs/config@^3.2.2 @nestjs/core@^10.3.8 @nestjs/jwt@^10.2.0 @rxap/nest-utilities@^10.4.1-dev.1 @rxap/pattern@^1.1.12-dev.0 rxjs@^7.8.1 
```
