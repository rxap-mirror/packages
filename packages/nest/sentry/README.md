...
```bash
yarn add @nestjs/common@^10.3.8 @nestjs/config@^3.2.2 @nestjs/core@^10.3.8 @rxap/nest-logger@^10.3.1-dev.3 @rxap/nest-utilities@^10.4.1-dev.1 @sentry/core@^8.18.0 @sentry/nestjs@^8.18.0 @sentry/node@^8.18.0 @sentry/profiling-node@^8.18.0 @sentry/types@^8.18.0 @sentry/utils@^8.18.0 rxjs@^7.8.1 
```
