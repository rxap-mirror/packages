...
@RxapForm('edit-data-grid-collection-demo')
@Injectable()
export class EditDataGridCollectionDemoForm implements FormType<IEditDataGridCollectionDemoForm> {
  public readonly rxapFormGroup!: RxapFormGroup<IEditDataGridCollectionDemoForm>;
  @UseFormControl()
...
export interface IEditDataGridCollectionDemoForm {
  name: unknown;
  age: number;
  isActive: boolean;
  email: unknown;
