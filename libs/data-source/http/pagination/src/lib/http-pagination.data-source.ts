...
export interface HttpPaginationDataSourceMetadata extends AbstractPaginationDataSourceMetadata {}

export type PageEventToHttpOptionsFunction = (event: PageEvent) => HttpDataSourceOptions;

@Injectable()
export class HttpPaginationDataSource<Data> extends AbstractPaginationDataSource<Data> {
