...
export interface HttpTableDataSourceMetadata extends AbstractTableDataSourceMetadata {}
...
export class HttpTableDataSource<Data extends Record<any, any>> extends AbstractTableDataSource<Data> {
  ...
  public tableEventToHttpOptions(event: TableEvent): HttpDataSourceOptions | Observable<HttpDataSourceOptions> | Promise<HttpDataSourceOptions> {
    throw new RxapHttpTableDataSourceError('The TableEventToHttpOptionsFunction is not defined', '');
  }

  protected _connect(viewer: HttpDataSourceViewer): [ Observable<Data[]>, TeardownLogic ] {
...
export function RxapHttpTableDataSource<Data extends Record<any, any>>(
  ...
  className: string   = 'HttpTableDataSource',
  packageName: string = '@rxap/data-source/http/table'
) {
