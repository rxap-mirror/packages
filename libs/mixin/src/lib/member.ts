export function Member(initial: null | number | boolean | string | symbol | Function = null) {
  return function(target: any, propertyKey: string) {
    Object.defineProperty(target, propertyKey, {
      get() {
        Object.defineProperty(this, propertyKey, { value: initial, writable: true, configurable: true, enumerable: true });
        return initial;
      },
      set(value) {
