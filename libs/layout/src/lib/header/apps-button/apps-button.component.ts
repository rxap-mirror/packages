...
export class AppsButtonComponent {
  ...
  public get gridWithPadding(): Array<AppsButtonGridItem | EmptyAppsButtonGridItem> {
    const gridWithPadding: Array<AppsButtonGridItem | EmptyAppsButtonGridItem> = this.grid.slice();
