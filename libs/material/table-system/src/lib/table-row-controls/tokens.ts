...
export const ROW_ARCHIVE_METHOD     = new InjectionToken<OpenApiRemoteMethod<any, { uuid: string }>>('archive-remote-method');
export const ROW_RESTORE_METHOD     = new InjectionToken<OpenApiRemoteMethod<any, { uuid: string }>>('unarchive-remote-method');
