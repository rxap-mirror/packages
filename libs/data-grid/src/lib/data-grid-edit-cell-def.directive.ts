...
export class DataGridEditCellDefDirective<T extends Record<string, any>> {
  ...
  public static ngTemplateContextGuard<T extends Record<string, any>>(dir: DataGridEditCellDefDirectiveContext<T>, ctx: any):
    ctx is DataGridEditCellDefDirectiveContext<T> {
    return true;
  }

  constructor(public template: TemplateRef<DataGridEditCellDefDirectiveContext<T>>) {}
