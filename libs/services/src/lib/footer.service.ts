...
export function IsFooterTemplate(obj: any): obj is FooterTemplate {
  return obj.hasOwnProperty('template');
}

export function IsFooterComponent(obj: any): obj is FooterComponent {
  return obj.hasOwnProperty('component');
}
...
export class FooterService {
   ...
   * @deprecated removed
   */
  public addComponent(component: Constructor, options: FooterComponentOptions = { order: 0 }, silent: boolean = false): void {
