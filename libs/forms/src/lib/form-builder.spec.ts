...
describe('@rxap/forms', () => {
  ...
  describe('FormBuilder', () => {
    ...
    @Injectable()
    @RxapForm('contact')
    class ContactForm implements FormDefinition {

      public rxapFormGroup!: RxapFormGroup;

      @UseFormControl()
      public zip!: RxapFormControl;
    ...
    class TestFormWithSubGroup implements FormDefinition {
    ...
    class TestFormWithSubArray implements FormDefinition {
    ...
    @Injectable()
    @RxapForm('test')
    class TestFormWithSubArrayControls implements FormDefinition {
      ...
      @UseFormArrayControl()
      public contacts!: FormDefinitionArray<RxapFormControl>;
    ...
    it('should build flat form', () => {
      ...
      const builder = new RxapFormBuilder(TestForm, Injector.create({ providers: [ { provide: TestForm, useClass: TestForm, deps: [] } ] }));
    ...
    it('should build form with sub group', () => {
      ...
      const formBuilder = new RxapFormBuilder(TestFormWithSubGroup, Injector.NULL, [
        {
    ...
    it('should build form with sub array', () => {
      ...
      const formBuilder = new RxapFormBuilder(TestFormWithSubArray, Injector.NULL, [
        {
    ...
    it('should build form with sub array controls', () => {
      ...
      const formBuilder = new RxapFormBuilder(TestFormWithSubArrayControls, Injector.NULL, [
        {
